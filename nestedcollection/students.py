...
# sd_django=[sd.get("name")  for sd in students if sd.get("course")=="django"]
# print(sd_django)

# marks_filter=[st.get("name")  for st in students if st.get("marks")>=300]
# print(marks_filter)

# gender_filter=[st.get("name")  for st in students if st.get("course")=="django" and st.get("gender")=="f"]
# print(gender_filter)

# max_st=max(students,key=lambda st:st.get("marks"))
# print(max_st.get("name"))

# min_st=min(students,key=lambda st:st.get("marks"))
# print(min_st)
